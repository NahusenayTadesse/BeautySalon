...
import DataTableSort from '$lib/components/Table/data-table-sort.svelte';
 ...
 export const columns = [
    ...
    { accessorKey: 'recieptLink',
      ...
      return renderComponent(DataTableLinks, { id: row.original.extraSettings, name: row.original.recieptLink, link: `/dashboard/files/${row.original.recieptLink}`});
    }},

   

       { accessorKey: 'extraSettings', header: '', cell: ({ row }) => {
      // You can pass whatever you need from `row.original` to the component
